...
const pageTitle = "Melbourne Airport To Southbank Transfer | Fixed-Price Chauffeur Service";
const pageDescription =
  "Book a fixed-price chauffeur transfer from Melbourne Airport to Southbank. Flight-tracked pickups, luxury vehicles and a professional driver, available 24/7.";

export const metadata: Metadata = {
  title: { absolute: pageTitle },
  description: pageDescription,
  keywords: [
    "Melbourne Airport To Southbank Transfer",
    "Airport To Southbank",
    "Tullamarine To Southbank",
    "Melbourne Airport Chauffeur Southbank",
    "Airport Transfer Crown Towers",
  ],
  alternates: { canonical: "/melbourne-airport-to-southbank" },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    locale: "en_AU",
    url: "/melbourne-airport-to-southbank",
...
const whyChooseFeatures = [
  ...
  { number: "02", icon: ShieldCheck, title: "Professional Chauffeurs", description: "Licensed drivers who know Southbank's hotel and apartment entrances." },
...
const fleetVehicles = [
  ...
  { icon: CarFront, name: "Luxury SUV", description: "Extra space for luggage, with a commanding ride into Southbank." },
  { icon: Users, name: "People Mover", description: "Generous capacity for groups and families travelling together." },
  { icon: Crown, name: "Luxury Vehicle", description: "Our flagship option for a premium arrival at Crown or Southbank." },
];

const bookingSteps = [
  { number: "01", title: "Request Quote", description: "Share your flight details for a fixed-price Southbank transfer." },
  ...
  { number: "04", title: "Enjoy Your Journey", description: "Your chauffeur meets you at arrivals and drives you straight to Southbank." },
];

const faqs = [
  { question: "How far is Southbank from Melbourne Airport?", answer: "Southbank is around 24km from Melbourne Airport, typically via the Tullamarine Freeway and CityLink." },
  { question: "How long does the transfer take?", answer: "A typical transfer takes around 30 minutes outside peak traffic, longer during busy periods." },
  ...
  { question: "Do you provide transfers to Crown Towers?", answer: "Yes, we regularly transfer guests to Crown Towers' Southbank entrance and nearby hotels." },
  ...
  { question: "Can I book a return transfer to the airport?", answer: "Yes, you can book your Southbank pickup and airport drop-off together, or arrange each leg separately." },
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  serviceType: "Melbourne Airport To Southbank Transfer",
  name: "Melbourne Airport To Southbank Transfer",
  description: pageDescription,
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Airport To Southbank", item: `${siteUrl}/melbourne-airport-to-southbank` },
  ],
};

export default function MelbourneAirportToSouthbankPage() {
  return (
    <main id="top" className="flex flex-1 flex-col">
      ...
      <ServiceHero
        ...
        title="Melbourne Airport To Southbank Transfer"
        description="A flight-tracked, fixed-price chauffeur transfer from Melbourne Airport straight to Southbank — professional driver, luxury vehicle, available 24/7."
        ...
        breadcrumbItems={[
          ...
          { label: "Airport To Southbank", href: "/melbourne-airport-to-southbank" },
        ]}
      />

      <ContentBlock
        eyebrow="Journey Overview"
        title="Melbourne Airport To Southbank"
        tone="white"
        paragraphs={[
          "The transfer from Melbourne Airport to Southbank is a popular route for guests staying at Crown Towers and the surrounding riverside hotels. After meeting you at arrivals, your chauffeur takes the Tullamarine Freeway and CityLink directly into Southbank, adjusting for traffic along the way.",
          "This route suits visitors staying at Southbank's hotels, guests attending events at Crown, and business travellers with meetings in the arts and entertainment precinct.",
        ]}
        highlights={[
          "Distance — approximately 24km",
          "Typical travel time — around 30 minutes outside peak traffic",
      ...
      <ContentBlock
        ...
        tone="white"
        paragraphs={[
          "Your Melbourne Airport to Southbank transfer is priced before you travel, based on your vehicle choice and passenger numbers. There are no metered surprises, no surge pricing during busy periods, and no hidden extras for standard luggage or waiting time within the allowance.",
      ...
      <BookingSteps
        ...
        intro="Booking your Melbourne Airport to Southbank transfer takes a few minutes — share your flight details, receive a fixed price, confirm your booking, and enjoy the journey."
        steps={bookingSteps}
      />
      ...
      <ServiceCTA
        title="Book Your Melbourne Airport To Southbank Transfer Today"
