...
const pageTitle = "Melbourne Airport To St Kilda Transfer | Fixed-Price Chauffeur Service";
const pageDescription =
  "Book a fixed-price chauffeur transfer from Melbourne Airport to St Kilda. Flight-tracked pickups, luxury vehicles and a professional driver, available 24/7.";

export const metadata: Metadata = {
  title: { absolute: pageTitle },
  description: pageDescription,
  keywords: [
    "Melbourne Airport To St Kilda Transfer",
    "Airport To St Kilda",
    "Tullamarine To St Kilda",
    "Melbourne Airport Chauffeur St Kilda",
    "Airport Transfer St Kilda",
  ],
  alternates: { canonical: "/melbourne-airport-to-st-kilda" },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    locale: "en_AU",
    url: "/melbourne-airport-to-st-kilda",
...
const whyChooseFeatures = [
  ...
  { number: "02", icon: ShieldCheck, title: "Professional Chauffeurs", description: "Licensed drivers who know the fastest routes to St Kilda at any hour." },
...
const fleetVehicles = [
  ...
  { icon: CarFront, name: "Luxury SUV", description: "Extra space for luggage, with a commanding ride to the beach." },
  { icon: Users, name: "People Mover", description: "Generous capacity for groups and families travelling together." },
  { icon: Crown, name: "Luxury Vehicle", description: "Our flagship option for a premium arrival into St Kilda." },
];

const bookingSteps = [
  { number: "01", title: "Request Quote", description: "Share your flight details for a fixed-price St Kilda transfer." },
  ...
  { number: "04", title: "Enjoy Your Journey", description: "Your chauffeur meets you at arrivals and drives you straight to St Kilda." },
];

const faqs = [
  { question: "How far is St Kilda from Melbourne Airport?", answer: "St Kilda is around 30km from Melbourne Airport, typically via CityLink and the Kings Way approach." },
  { question: "How long does the transfer take?", answer: "A typical transfer takes around 40 minutes outside peak traffic, longer during busy periods." },
  ...
  { question: "Can I book a return transfer to the airport?", answer: "Yes, you can book your St Kilda pickup and airport drop-off together, or arrange each leg separately." },
  { question: "Which St Kilda addresses do you cover?", answer: "We cover all of St Kilda, including the Esplanade, Fitzroy Street and surrounding residential streets." },
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  serviceType: "Melbourne Airport To St Kilda Transfer",
  name: "Melbourne Airport To St Kilda Transfer",
  description: pageDescription,
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Airport To St Kilda", item: `${siteUrl}/melbourne-airport-to-st-kilda` },
  ],
};

export default function MelbourneAirportToStKildaPage() {
  return (
    <main id="top" className="flex flex-1 flex-col">
      ...
      <ServiceHero
        ...
        title="Melbourne Airport To St Kilda Transfer"
        description="A flight-tracked, fixed-price chauffeur transfer from Melbourne Airport straight to St Kilda — professional driver, luxury vehicle, available 24/7."
        ...
        breadcrumbItems={[
          ...
          { label: "Airport To St Kilda", href: "/melbourne-airport-to-st-kilda" },
        ]}
      />

      <ContentBlock
        eyebrow="Journey Overview"
        title="Melbourne Airport To St Kilda"
        tone="white"
        paragraphs={[
          "The transfer from Melbourne Airport to St Kilda takes you from Tullamarine, through the CBD and down to Melbourne's best-known beachside suburb. After meeting you at arrivals, your chauffeur takes the fastest available route via CityLink, adjusting for traffic along the way.",
          "This route suits holidaymakers staying near the Esplanade, visitors booked into St Kilda's hotels and apartments, and anyone who wants a direct, private transfer rather than a long trip on public transport with luggage.",
        ]}
        highlights={[
          "Distance — approximately 30km",
          "Typical travel time — around 40 minutes outside peak traffic",
          "Peak-hour travel time — up to 55 minutes",
          "Route — CityLink and St Kilda Road",
        ]}
      />
      ...
      <ContentBlock
        ...
        tone="white"
        paragraphs={[
          "Your Melbourne Airport to St Kilda transfer is priced before you travel, based on your vehicle choice and passenger numbers. There are no metered surprises, no surge pricing during busy periods, and no hidden extras for standard luggage or waiting time within the allowance.",
      ...
      <BookingSteps
        ...
        intro="Booking your Melbourne Airport to St Kilda transfer takes a few minutes — share your flight details, receive a fixed price, confirm your booking, and enjoy the journey."
        steps={bookingSteps}
      />
      ...
      <ServiceCTA
        title="Book Your Melbourne Airport To St Kilda Transfer Today"
