...
export const metadata: Metadata = {
  ...
  keywords: [
    "Melbourne Airport To Docklands Transfer",
    "Airport To Docklands",
    "Tullamarine To Docklands",
    "Melbourne Airport Chauffeur Docklands",
    "Airport Transfer Docklands",
  ],
  alternates: { canonical: "/melbourne-airport-to-docklands" },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    locale: "en_AU",
    url: "/melbourne-airport-to-docklands",
...
const whyChooseFeatures = [
  ...
  { number: "02", icon: ShieldCheck, title: "Professional Chauffeurs", description: "Licensed drivers who know Docklands' apartment towers and event venues." },
...
const fleetVehicles = [
  ...
  { icon: CarFront, name: "Luxury SUV", description: "Extra space for luggage, with a commanding ride into Docklands." },
  { icon: Users, name: "People Mover", description: "Generous capacity for groups and families travelling together." },
  { icon: Crown, name: "Luxury Vehicle", description: "Our flagship option for a premium arrival into Docklands." },
];

const bookingSteps = [
  { number: "01", title: "Request Quote", description: "Share your flight details for a fixed-price Docklands transfer." },
  ...
  { number: "04", title: "Enjoy Your Journey", description: "Your chauffeur meets you at arrivals and drives you straight to Docklands." },
];

const faqs = [
  { question: "How far is Docklands from Melbourne Airport?", answer: "Docklands is around 20km from Melbourne Airport, typically via the Tullamarine Freeway and CityLink." },
  { question: "How long does the transfer take?", answer: "A typical transfer takes around 25 minutes outside peak traffic, longer during busy periods or major stadium events." },
  ...
  { question: "Do you provide transfers for events at Marvel Stadium?", answer: "Yes, we provide transfers to and from Docklands for stadium events, accounting for extra event-day traffic." },
  ...
  { question: "Can I book a return transfer to the airport?", answer: "Yes, you can book your Docklands pickup and airport drop-off together, or arrange each leg separately." },
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  serviceType: "Melbourne Airport To Docklands Transfer",
  name: "Melbourne Airport To Docklands Transfer",
  description: pageDescription,
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Airport To Docklands", item: `${siteUrl}/melbourne-airport-to-docklands` },
  ],
};

export default function MelbourneAirportToDocklandsPage() {
  return (
    <main id="top" className="flex flex-1 flex-col">
      ...
      <ServiceHero
        ...
        title="Melbourne Airport To Docklands Transfer"
        description="A flight-tracked, fixed-price chauffeur transfer from Melbourne Airport straight to Docklands — professional driver, luxury vehicle, available 24/7."
        ...
        breadcrumbItems={[
          ...
          { label: "Airport To Docklands", href: "/melbourne-airport-to-docklands" },
        ]}
      />

      <ContentBlock
        eyebrow="Journey Overview"
        title="Melbourne Airport To Docklands"
        tone="white"
        paragraphs={[
          "The transfer from Melbourne Airport to Docklands is one of the shortest airport routes into inner Melbourne, popular with guests staying in Docklands' waterfront apartments and those attending events at Marvel Stadium. Your chauffeur takes the Tullamarine Freeway and CityLink directly into the precinct.",
          "This route suits business travellers with offices in Docklands, visitors attending stadium events, and guests staying at the precinct's waterfront hotels and apartments.",
        ]}
        highlights={[
          "Distance — approximately 20km",
          "Typical travel time — around 25 minutes outside peak traffic",
          "Event-day travel time — allow extra time around major Marvel Stadium events",
      ...
      <ContentBlock
        ...
        tone="white"
        paragraphs={[
          "Your Melbourne Airport to Docklands transfer is priced before you travel, based on your vehicle choice and passenger numbers. There are no metered surprises, no surge pricing during busy periods, and no hidden extras for standard luggage or waiting time within the allowance.",
      ...
      <BookingSteps
        ...
        intro="Booking your Melbourne Airport to Docklands transfer takes a few minutes — share your flight details, receive a fixed price, confirm your booking, and enjoy the journey."
        steps={bookingSteps}
      />
      ...
      <ServiceCTA
        title="Book Your Melbourne Airport To Docklands Transfer Today"
